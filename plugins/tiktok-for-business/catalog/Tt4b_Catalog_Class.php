...
class Tt4b_Catalog_Class {
	...
	public function init() {
		...
		add_action( 'tt4b_delete_products_helper', [ $this, 'delete_products_helper' ], 1, 4 );
	}
	 ...
	 * @return void
	 */
	public function delete_products_helper( $catalog_id, $bc_id, $store_name, $access_token ) {
		...
		if ( 0 === count( $sku_ids ) ) {
			...
			$this->mapi->mapi_post( 'catalog/product/delete/', $access_token, $dpa_product_information, 'v1.2' );
	...
	public function catalog_sync_helper( $catalog_id, $bc_id, $store_name, $access_token, $page ) {
		...
		$this->mapi->mapi_post( 'catalog/product/upload/', $access_token, $dpa_product_information, 'v1.2' );
