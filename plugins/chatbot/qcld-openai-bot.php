                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check form-switch my-4">
                                <input class="form-check-input" type="checkbox" <?php echo (get_option( 'ai_enabled') == 1) ? 'checked' :'';?>  role="switch" value="" id="is_ai_enabled">
                                <label class="form-check-label" for="is_ai_enabled">
                                <?php  esc_html_e( 'Enable Open AI','openai_addon');?>
                                </label>
                            </div>
                            <div class="form-check form-switch my-4">
                                <input class="form-check-input" type="checkbox" <?php echo (get_option( 'ai_only_mode') == 1) ? 'checked' :'';?>  role="switch" value="" id="is_ai_only_mode">
                            ...
                            <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="api_key" name="api_key" placeholder="Api key" value="<?php echo get_option( 'open_ai_api_key'); ?>">
                            </div>
                            <div class="mb-3">
                                <label for="max_tokens" class="form-label"><?php esc_html_e( 'Max tokens (0-4000) Depending on the model','openai_addon');?></label>
                                <input id="max_tokens" class="form-control" type="text" name="max_tokens" value="<?php echo get_option( 'openai_max_tokens'); ?>">
                            </div>
                            <div class="mb-3">
                                <div class="row gx-0"><div class="col-8"><label for="temperature" class="form-label"><?php esc_html_e( 'Temperature','openai_addon');?></label></div><div class="col-4 me-auto text-end"><span name="temperatureout" id="temperatureout" ><?php echo get_option( 'openai_temperature'); ?></span></div></div>
                                <input id="temperature" type="range" class="form-range" min="0" max="1" step="0.01" name="temperature" value="<?php echo get_option( 'openai_temperature'); ?>"  onchange="updateTemp(this.value);" />
                            ...
                            <div class="mb-3">
                                <div class="row gx-0"><div class="col-8"><label for="presence_penalty" class="form-label"><?php esc_html_e( 'Presence Penalty','openai_addon');?></label></div><div class="col-4 me-auto text-end"><span id="presence_penalty_out" ><?php echo get_option( 'presence_penalty'); ?></span></div></div>
                                <input id="presence_penalty" type="range" class="form-range" min="-2" max="2" step="0.1" name="presence_penalty" value="<?php echo get_option( 'presence_penalty'); ?>">
                            ...
                            <div class="mb-3">
                                <div class="row gx-0"><div class="col-8"><label for="frequency_penalty" class="form-label"><?php esc_html_e( 'Frequency penalty','openai_addon');?></label></div><div class="col-4 me-auto text-end"><span id="frequency_penalty_out" ><?php echo get_option( 'frequency_penalty'); ?></span></div></div>
                                <input id="frequency_penalty" type="range" class="form-range" min="-2" max="2" step="0.1" name="frequency_penalty" value="<?php echo get_option( 'frequency_penalty'); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="custom_prompt_wrapper">
                                    <input type="hidden" id="custom_promt_value" value="<?php echo get_option('qcld_openai_prompt_custom'); ?>"/>
                                </div>
