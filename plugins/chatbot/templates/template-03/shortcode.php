<div id="wp-chatbot-shortcode-template-container" class="<?php echo esc_attr($wp_chatbot_enable_rtl);?> wp-chatbot-shortcode-template-container chatbot-shortcode-template-03">
