<div id="wp-chatbot-shortcode-template-container"
     class="<?php echo esc_html($wp_chatbot_enable_rtl);?> wp-chatbot-shortcode-template-container template-vertical">
        ...
        <div class="chatbot-sidebar chatbot-left-sidebar">
            <div class="wp-chatbot-widget">
                <div class="chatbot-agent">
                    ...
                    <h3 class="chatbot-agent-name"><?php echo qcld_wpb_randmom_message_handle(maybe_unserialize(get_option('qlcd_wp_chatbot_agent'))); ?></h3>
                </div>
                <!--chatbot-agent-->
            </div>
            <!--wp-chatbot-widget-->
