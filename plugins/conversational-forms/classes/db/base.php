 ...
 */
abstract class Qcformbuilder_Forms_DB_Base {
	...
	public function get_fields(){
		...
		if ( $this->has_meta ) {
			 ...
			 */
			$fields[ 'meta_fields' ] = apply_filters( 'qcformbuilder_forms_db_meta_fields', array_keys( $this->meta_fields ), $this->get_table_name( true ) );
