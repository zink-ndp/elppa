...
if(!empty($field['config']['placeholder'])){
	$attrs[ 'placeholder' ] = Qcformbuilder_Forms::do_magic_tags( $field['config']['placeholder'] );
}
...
if(!empty($field['config']['default'])){
	$attrs[ 'default' ] = $field_value =  Qcformbuilder_Forms::do_magic_tags( $field['config']['default'] );
}
