<div class="qcformbuilder-config-group">
	<label for="{{_id}}_element"><?php echo __('Element', 'qcformbuilder-forms'); ?></label>
...
<div class="qcformbuilder-config-group">
	<label for="{{_id}}_classes"><?php echo __('Classes', 'qcformbuilder-forms'); ?></label>
	<div class="qcformbuilder-config-field">
...
<div class="qcformbuilder-config-group">
	<div class="qcformbuilder-config-field">
		<label><input id="{{_id}}_fixed" type="checkbox" class="field-config" name="{{_name}}[fixed]" value="1" {{#if fixed}}checked="checked"{{/if}}> <?php echo __('Money Format', 'qcformbuilder-forms'); ?></label>
	</div>
</div>
