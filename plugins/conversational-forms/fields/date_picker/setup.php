...
<div class="qcformbuilder-config-group">
	<label for="{{_id}}_format">
        <?php esc_html_e('Format', 'qcformbuilder-forms'); ?>
    </label>
	<div class="qcformbuilder-config-field">
...
<div class="qcformbuilder-config-group">
    <label>
        <?php esc_html_e('Autoclose', 'qcformbuilder-forms'); ?>
    </label>
    <div class="qcformbuilder-config-field">
        <label id="{{_id}}_autoclosed">
            ...
            <?php esc_html_e('Enable autoclose', 'qcformbuilder-forms'); ?>
        </label>
        <p class="description" id="{{_id}}_autoclosed-description">
            <?php esc_html_e('If enabled, the date picker will automatically close after selecting the final input', 'qcformbuilder-forms'); ?>
        </p>
    </div>
</div>
<div class="qcformbuilder-config-group">
    <label for="{{_id}}_startview">
        <?php esc_html_e('Start View', 'qcformbuilder-forms'); ?>
    </label>
    <div class="qcformbuilder-config-field">
        <select class="block-input field-config" name="{{_name}}[start_view]" id="{{_id}}_startview" aria-describedby="{{_id}}_startview-description">
            <option value="month" {{#is start_view value="month"}}selected="selected"{{/is}}>
                <?php esc_html_e('Month (Default)', 'qcformbuilder-forms'); ?>
            </option>
            <option value="year" {{#is start_view value="year"}}selected="selected"{{/is}}>
                <?php esc_html_e('Year', 'qcformbuilder-forms'); ?>
            </option>
            <option value="decade" {{#is start_view value="decade"}}selected="selected"{{/is}}>
                <?php esc_html_e('Decade', 'qcformbuilder-forms'); ?>
            </option>
        </select>
        <p class="description" id="{{_id}}_startview-description"><?php _e('The starting view of the date picker (month, year, decade)', 'qcformbuilder-forms'); ?></p>
    </div>
</div>
<div class="qcformbuilder-config-group">
    <label for="{{_id}}_startdate">
        <?php esc_html_e('Start Date', 'qcformbuilder-forms'); ?>
    </label>
    <div class="qcformbuilder-config-field">
        ...
        <p class="description" id="{{_id}}_startdate-description">
            <?php esc_html_e('The starting date of the date picker like +1d, -2y, +4m. 0d for today.', 'qcformbuilder-forms'); ?>
        </p>
    </div>
</div>
<div class="qcformbuilder-config-group">
    <label for="{{_id}}_end-date">
        <?php esc_html_e('End Date', 'qcformbuilder-forms'); ?>
    </label>
    <div class="qcformbuilder-config-field">
        ...
        <p class="description" id="{{_id}}_end-date-description">
                <?php esc_html_e('The ending date of the date picker like +1d, -2y, +4m. 0d for today.', 'qcformbuilder-forms'); ?>
        </p>
    </div>
</div>
<div class="qcformbuilder-config-group">
	<label for="{{_id}}_language">
        <?php esc_html_e('language', 'qcformbuilder-forms'); ?>
    </label>
	<div class="qcformbuilder-config-field">
		...
		<p class="description" id="{{_id}}_language-description">
            <?php esc_html_e('Language to use. e.g. pt-BR', 'qcformbuilder-forms'); ?>
        </p>
	</div>
</div>
