...
<div class="qcformbuilder-config-group">
	<label for="{{_id}}_agreement">
        <?php esc_html_e( 'Agreement', 'qcformbuilder-forms' ); ?>
	</label>
	<div class="qcformbuilder-config-field">
        <textarea
				data-id="{{_id}}"
		...
		>
            <?php esc_html_e( 'The terms of the agreement to data collection.', 'qcformbuilder-forms' ); ?>
		</p>
	</div>
</div>
...
<div class="qcformbuilder-config-group">
    <label for="{{_id}}_linked_text">
        <?php esc_html_e( 'Linked Text', 'qcformbuilder-forms' ); ?>
    </label>
    <div class="qcformbuilder-config-field">
        <input
				required
		...
		>
            <?php esc_html_e( 'This text will be linked to Privacy Policy content page.', 'qcformbuilder-forms' ); ?>
        </p>
    </div>
</div>
...
<div class="qcformbuilder-config-group">
	<label for="{{_id}}_title_attr">
        <?php esc_html_e( 'Link\'s title attribute', 'qcformbuilder-forms' ); ?>
	</label>
	<div class="qcformbuilder-config-field">
		<input
			data-id="{{_id}}"
		...
		>
		<?php esc_html_e( 'The text to be used as the title attribute of the Privacy Page link (leave empty to not display title attribute).', 'qcformbuilder-forms' ); ?>
        </p>
	</div>
</div>
