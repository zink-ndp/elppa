...
$privacy_page_url = qcformbuilder_forms_privacy_policy_page_url();

if( !empty( $field['config']['title_attr'] ) ) {
    $title_attribute = $field['config']['title_attr'];
}else{
    $title_attribute = __('Privacy Policy Page', 'qcformbuilder-forms');
}
?>

<div class="checkbox-inline qcformbuilder-forms-consent-field">
    ...
    <label for="<?php echo esc_attr( $field_id); ?>"
           class="qcformbuilder-forms-gdpr-field-label"
    ...
    >
        ...
        ?>
        <p
            class="qcformbuilder-forms-consent-field-agreement"
        >
        ...
        <a href="<?php echo esc_url( $privacy_page_url ); ?>"
           target="_blank"
            ...
            class="qcformbuilder-forms-consent-field-linked_text"
            >
