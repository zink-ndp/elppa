...
<p class="description" style="text-align:center;"><?php esc_html_e('reCaptcha required keys from Google.', 'qcformbuilder-forms'); ?><a href="https://www.google.com/recaptcha" target="_blank"> Visit reCAPTCHA</a></p>
<div class="qcformbuilder-config-group">
	<label for="{{_id}}_public">
        <?php esc_html_e('Site Key', 'qcformbuilder-forms'); ?>
    </label>
...
<div class="qcformbuilder-config-group">
	<label for="{{_id}}_secret">
        <?php esc_html_e('Secret Key', 'qcformbuilder-forms'); ?>
    </label>
	<div class="qcformbuilder-config-field">
...
<div class="qcformbuilder-config-group">
	<label for="{{_id}}_theme">
        <?php esc_html_e('Theme', 'qcformbuilder-forms'); ?>
    </label>
	<div class="qcformbuilder-config-field">
		...
		<p class="description" id="{{_id}}_theme-description">
            <?php esc_html_e('Theme changes not available in preview. Save the form and reload to see new theme.', 'qcformbuilder-forms'); ?>
        </p>
	</div>
</div>
