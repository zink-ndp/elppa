...
$star_target = Qcformbuilder_Forms_Field_Util::star_target( Qcformbuilder_Forms_Field_Util::get_base_id( $field, null, $form ) );
...
<?php
Qcformbuilder_Forms_Render_Util::add_inline_data( ob_get_clean(), $form );
