<div class="qcformbuilder-config-group">
	<label><?php echo __('Progress Bar', 'qcformbuilder-forms'); ?></label>
	<div class="qcformbuilder-config-field">
		<label><input type="checkbox" name="config[auto_progress]" value="1" <?php if(!empty($element['auto_progress'])){ echo 'checked="checked"'; } ?>> <?php echo __('Show Breadcrumbs', 'qcformbuilder-forms'); ?></label>
		<p class="description"><?php echo __('ProTip: Use an HTML element to build a custom progress per page', 'qcformbuilder-forms'); ?></p>
	</div>
</div>
...
<div class="qcformbuilder-config-group">
	<label><?php echo __('Page', 'qcformbuilder-forms'); ?> {{page_no}}</label>
	<div class="qcformbuilder-config-field">
