...
<div class="qcformbuilder-config-group">
	...
	<div class="qcformbuilder-config-field" style="margin: 0px; padding: 4px 0px; width: 401px;">
		<div><?php echo __('Value', 'qcformbuilder-forms'); ?></div>
	</div>
	<?php echo __('Behaviour', 'qcformbuilder-forms'); ?>
</div>
<div id="variable_entry_list_none" <?php if(!empty($element['variables'])){ echo 'style="display:none;"'; } ?>><p class="description"><?php echo __('No variables defined', 'qcformbuilder-forms'); ?></p></div>
		...
		foreach($element['variables']['keys'] as $var_index=>$var_value){
			...
			<div class="qcformbuilder-config-group">
				...
				<select name="config[variables][types][]" class="field-config" style="vertical-align: baseline;">
					<option value="static" <?php if( $element['variables']['types'][$var_index] == 'static'){ echo 'selected="selected"'; } ?>><?php echo __('Static', 'qcformbuilder-forms'); ?></option>
					<option value="passback" <?php if( $element['variables']['types'][$var_index] == 'passback'){ echo 'selected="selected"'; } ?>><?php echo __('Passback', 'qcformbuilder-forms'); ?></option>
					<option value="entryitem" <?php if( $element['variables']['types'][$var_index] == 'entryitem'){ echo 'selected="selected"'; } ?>><?php echo __('Entry List', 'qcformbuilder-forms'); ?></option>
				</select>
...
<script type="text/html" id="variable-fields-tmpl">
	<div class="qcformbuilder-config-group">
		...
		<select name="config[variables][types][]" class="field-config" style="vertical-align: baseline;">
			<option value="static"><?php echo __('Static', 'qcformbuilder-forms'); ?></option>
			<option value="passback"><?php echo __('Passback', 'qcformbuilder-forms'); ?></option>
			<option value="entryitem"><?php echo __('Entry List', 'qcformbuilder-forms'); ?></option>
		</select>
		&nbsp;<button type="button" class="button remove-this-variable">&times;</button>
	</div>
</script>
