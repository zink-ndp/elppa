<?php
/**
 * Qcformbuilder Forms - Registration form example.
 *
 * @since 1.3.0
 *
 ...
 * @license   GPL-2.0+
 * @link
 * @copyright 2015 QuantumCloud for CalderaWP LLC
 */
return array (
	'_last_updated' => 'Fri, 21 Aug 2015 20:42:39 +0000',
	'ID' => 'CF55d78d3e3624f',
	'name' => __( 'Registration Form', 'qcformbuilder-forms' ),
	'description' => '',
	'db_support' => 1,
	'pinned' => 0,
	'hide_form' => 1,
		...
		array (
			'fld_1327818' =>
				array (
					'ID' => 'fld_1327818',
					'type' => 'toggle_switch',
					'label' => __( 'Number of People', 'qcformbuilder-forms' ),
							...
							'option' =>
								array (
									'opt1186018' =>
										array (
											'value' => '',
											'label' => __( 'One', 'qcformbuilder-forms' ),
										),
									'opt1400463' =>
										array (
											'value' => '',
											'label' => __( 'Two', 'qcformbuilder-forms' ),
										),
									'opt1453751' =>
										array (
											'value' => '',
											'label' => __( 'Three', 'qcformbuilder-forms' ),
										),
								),
						),
				),
			'fld_1812913' =>
				array (
					'ID' => 'fld_1812913',
					'type' => 'text',
					'label' => __( 'Person One Name', 'qcformbuilder-forms' ),
			...
			'fld_7290902' =>
				array (
					'ID' => 'fld_7290902',
					'type' => 'email',
					'label' => __( 'Person One Email', 'qcformbuilder-forms' ),
			...
			'fld_6900741' =>
				array (
					'ID' => 'fld_6900741',
					'type' => 'text',
					'label' => __( 'Person Two Name', 'qcformbuilder-forms' ),
			...
			'fld_1561974' =>
				array (
					'ID' => 'fld_1561974',
					'type' => 'email',
					'label' => __( 'Person Two Email', 'qcformbuilder-forms' ),
			...
			'fld_2458053' =>
				array (
					'ID' => 'fld_2458053',
					'type' => 'email',
					'label' => __( 'Person Three Email', 'qcformbuilder-forms' ),
			...
			'fld_6241168' =>
				array (
					'ID' => 'fld_6241168',
					'type' => 'text',
					'label' => __( 'Person Three Name', 'qcformbuilder-forms' ),
			...
			'fld_2668148' =>
				array (
					'ID' => 'fld_2668148',
					'type' => 'button',
					'label' => __( 'Submit', 'qcformbuilder-forms' ),
					'slug' => 'submit',
					'conditions' =>
						array (
							'type' => '',
				...
				array (
					'con_9457156563497745' =>
						array (
							...
							'name' => __( 'Two People', 'qcformbuilder-forms' ),
							'type' => 'show',
							'fields' =>
								array (
					...
					'con_4812944559945067' =>
						array (
							...
							'name' => __( 'Three People', 'qcformbuilder-forms' ),
							'type' => 'show',
							'group' =>
								array (
									'rw1885912614213066' =>
	...
	'mailer' =>
		array (
			'enable_mailer' => 1,
			'sender_name' => __( 'Chatbot Forms Notification', 'qcformbuilder-forms' ),
