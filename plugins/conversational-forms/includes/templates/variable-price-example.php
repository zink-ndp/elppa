<?php
/**
 * Qcformbuilder Forms - Variable pricing example
 *
 * @since 1.3.0
 *
...
return array (
	...
	'wfb_version' => '1.8.0',
	'name' => __( 'Variable Price Example', 'qcformbuilder-forms' ),
	'scroll_top' => 0,
		...
		array(
			...
			'fld_1316929' =>
				array(
					'ID' => 'fld_1316929',
					'type' => 'hidden',
					'label' => __( 'Value Big', 'qcformbuilder-forms' ),
					'slug' => 'value_big',
					'conditions' =>
						array(
			...
			'fld_6796077' =>
				array(
					'ID' => 'fld_6796077',
					'type' => 'hidden',
					'label' => __( 'Value Small', 'qcformbuilder-forms' ),
					'slug' => 'value_small',
					'conditions' =>
						array(
			...
			'fld_5987102' =>
				array(
					'ID' => 'fld_5987102',
					'type' => 'hidden',
					'label' => __( 'Base', 'qcformbuilder-forms' ),
					'slug' => 'base',
					'conditions' =>
						array(
							'type' => '',
			...
			'fld_3993413' =>
				array(
					'ID' => 'fld_3993413',
					'type' => 'checkbox',
					'label' => __( 'Want Option 1?', 'qcformbuilder-forms' ),
					'slug' => 'option_1',
					'conditions' =>
						array(
							'type' => '',
								...
								array(
									'opt1697235' =>
										array(
											'calc_value' => 'Yes',
											'value' => 'Yes',
											'label' => __( 'Yes', 'qcformbuilder-forms' ),
										),
								),
							'email_identifier' => 0,
							'personally_identifying' => 0,
			...
			'fld_5161425' =>
				array(
					'ID' => 'fld_5161425',
					'type' => 'dropdown',
					'label' => __('Option 2 Type', 'qcformbuilder-forms' ),
					'slug' => 'option_2',
					'conditions' =>
						array(
							'type' => '',
								...
								array(
									'opt1533135' =>
										array(
											'calc_value' => 'Big',
											'value' => 'Big',
											'label' => __( 'Big', 'qcformbuilder-forms' ),
										),
									'opt1786217' =>
										array(
											'calc_value' => 'Small',
											'value' => 'Small',
											'label' => __( 'Small', 'qcformbuilder-forms' ),
										),
								),
							'email_identifier' => 0,
							'personally_identifying' => 0,
			...
			'fld_8997460' =>
				array(
					'ID' => 'fld_8997460',
					'type' => 'calculation',
					'label' => __( 'Total', 'qcformbuilder-forms' ),
					'slug' => 'total',
					'conditions' =>
						array(
							'type' => '',
			...
			'fld_1338703' =>
				array(
					'ID' => 'fld_1338703',
					'type' => 'button',
					'label' => __( 'Pay', 'qcformbuilder-forms' ),
					'slug' => 'pay',
					'conditions' =>
						array(
							'type' => '',
