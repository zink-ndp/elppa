...
use qcformbuilderwp\qcformbuilderforms\pro\api\log;
...
class container extends repository
{
	...
	public function get_messages_db()
	{
		if ( !$this->has('db') ) {
			global $wpdb;
			$table_name = $wpdb->prefix . 'wfb_pro_messages';
			$this->set(
				'db',
	...
	/**
	 * Get the HTML to be used in Qcformbuilder Forms Pro tab
	 *
	 * @since 1.0.0
	 *
	 * @return string
	...
	/**
	 * Set the HTML to be used in Qcformbuilder Forms Pro tab
	 *
	 * @since 1.0.0
	 *
	 * @param $html
	...
	/**
	 * Set main instance of Qcformbuilder_Forms_DB_Tables class
	 *
	 * @since 0.5.0
	 *
	 * @param \Qcformbuilder_Forms_DB_Tables $DB_Tables
	 */
	public function set_tables(\Qcformbuilder_Forms_DB_Tables $DB_Tables)
	{
		$this->set('tables', $DB_Tables);
	}

	/**
	 * Get main instance of Qcformbuilder_Forms_DB_Tables class
	 *
	 * @since 0.5.0
	 *
	 * @return \Qcformbuilder_Forms_DB_Tables
	 */
