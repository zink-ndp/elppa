...
{ 
	...
	$instance_bot23->upgrade_link = "https://www.quantumcloud.com/products/conversations-and-form-builder/";
	...
	$instance_bot23->plugin_slug = 'conversational-forms'; //Plugin Slug. i.e. Folder Name
	$instance_bot23->plugin_main_file = 'qcformbuilder-core.php'; //Primary file of the pluign
	$instance_bot23->plugin_menu_slug = 'qcformbuilder-forms'; //Main Menu Slug

	$instance_bot23->show_with_action_links = true; //show in plugin.php page
	$instance_bot23->show_with_meta_links = true; //show in plugin.php page
	$instance_bot23->show_with_plugin_menu = true; //show inside parent menu of the plugin
	...
	$instance_bot23->hook_with_plugin_submenu();
