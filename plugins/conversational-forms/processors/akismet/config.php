<div class="qcformbuilder-config-group">
	<label><?php echo __('Name', 'qcformbuilder-forms'); ?> </label>
...
<div class="qcformbuilder-config-group">
	<label><?php echo __('Email', 'qcformbuilder-forms'); ?> </label>
	<div class="qcformbuilder-config-field">
...
<div class="qcformbuilder-config-group">
	<label><?php echo __('Content', 'qcformbuilder-forms'); ?> </label>
	<div class="qcformbuilder-config-field">
...
<div class="qcformbuilder-config-group">
	<label><?php echo __('Error Message', 'qcformbuilder-forms'); ?> </label>
	<div class="qcformbuilder-config-field">
		<input type="text" class="block-input field-config magic-tag-enabled qcformbuilder-field-bind" id="{{_id}}_error" name="{{_name}}[error]" value="{{#if error}}{{error}}{{else}}<?php echo __('Sorry, that looked very spammy, try rephrasing things', 'qcformbuilder-forms'); ?>{{/if}}">
	</div>
</div>
