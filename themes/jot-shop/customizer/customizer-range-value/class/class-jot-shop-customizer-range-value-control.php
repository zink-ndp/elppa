 ...
 * @access public
 */
class Jot_Shop_WP_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	public function enqueue(){
		wp_enqueue_script( 'customizer-range-value-control', JOT_SHOP_THEME_URI . 'customizer/customizer-range-value/js/customizer-range-value-control.js', array( 'jquery', 'customize-base' ), '1.0.0', true );
		wp_enqueue_style( 'customizer-range-value-control', JOT_SHOP_THEME_URI . 'customizer/customizer-range-value/css/customizer-range-value-control.css', array(), '1.0.0' );
	}
	/**
	 * Handles input value.
	 *
 ...
 * @since 1.1.38
 */
function jot_shop_sanitize_range_value( $input ){
	if ( jot_shop_is_json( $input ) ) {
