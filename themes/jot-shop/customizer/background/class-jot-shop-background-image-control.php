...
/**
 * Customize API: Jot_Shop_Customize_Custom_Background_Control class
 *
...
class Jot_Shop_Customize_Custom_Background_Control extends WP_Customize_Upload_Control{
	...
	public static function get_button_labels() {
		...
		$button_labels = array(
			'select'       => __( 'Select Image', 'jot-shop' ),
			'change'       => __( 'Change Image', 'jot-shop' ),
			'remove'       => __( 'Remove', 'jot-shop' ),
			'default'      => __( 'Default', 'jot-shop' ),
			'placeholder'  => __( 'No image selected', 'jot-shop' ),
			'frame_title'  => __( 'Select Image', 'jot-shop' ),
			'frame_button' => __( 'Choose Image', 'jot-shop' ),
		);
	...
	public static function get_field_labels() {
		...
		$field_labels = array(
			'repeat'	=> __( 'Background Repeat', 'jot-shop' ),
			'size'		=> __( 'Background Size', 'jot-shop' ),
			'position'	=> __( 'Background Position', 'jot-shop' ),
			'attach'	=> __( 'Background Attachment', 'jot-shop' )
		);
	...
	public static function get_background_choices() {
		...
		$choices = array(
			'repeat' => array(
				'no-repeat' => __( 'No Repeat', 'jot-shop' ),
				'repeat'    => __( 'Tile', 'jot-shop' ),
				'repeat-x'  => __( 'Tile Horizontally', 'jot-shop' ),
				'repeat-y'  => __( 'Tile Vertically', 'jot-shop' )
			),
			'size' => array(
				'auto'    => __( 'Default', 'jot-shop' ),
				'cover'   => __( 'Cover', 'jot-shop' ),
				'contain' => __( 'Contain', 'jot-shop' )
			),
			'position' => array(
				'left top'      => __( 'Left Top', 'jot-shop' ),
				'left center'   => __( 'Left Center', 'jot-shop' ),
				'left bottom'   => __( 'Left Bottom', 'jot-shop' ),
				'right top'     => __( 'Right Top', 'jot-shop' ),
				'right center'  => __( 'Right Center', 'jot-shop' ),
				'right bottom'  => __( 'Right Bottom', 'jot-shop' ),
				'center top'    => __( 'Center Top', 'jot-shop' ),
				'center center' => __( 'Center Center', 'jot-shop' ),
				'center bottom' => __( 'Center Bottom', 'jot-shop' )
			),
			'attach' => array(
				'fixed'   => __( 'Fixed', 'jot-shop' ),
				'scroll'  => __( 'Scroll', 'jot-shop' )
			)
		);
