...
jQuery('#_customize-input-jot_shop_pagination option[value="click"],#_customize-input-jot_shop_pagination option[value="scroll"],#_customize-input-jot_shop_blog_post_pagination option[value="scroll"],#_customize-input-jot_shop_blog_post_pagination option[value="click"],#customize-control-jot_shop_main_header_option option[value="button"],#customize-control-jot_shop_main_header_option option[value="widget"],#_customize-input-jot_shop_woo_product_animation option[value="swap"],#_customize-input-jot_shop_woo_product_animation option[value="slide"]').attr("disabled", true);
...
// section sorting
 ...
 //hide show option
 wp.customize('jot_shop_top_slide_layout', function( value ) {
