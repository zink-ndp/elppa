...
OPNCustomizerToggles ['jot_shop_above_footer_layout'] = [
		    {
				controls: [    
				'jot_shop_above_footer_col1_set',
				'jot_shop_above_footer_col2_set',
				'jot_shop_above_footer_col3_set',
				'jot_shop_footer_col1_texthtml',
				'jot_shop_footer_col1_widget_redirect',
	            'jot_shop_footer_col1_menu_redirect',
				'jot_shop_footer_col1_social_media_redirect',
				'jot_shop_above_footer_col2_texthtml',
				'jot_shop_above_footer_col2_widget_redirect',
				'jot_shop_above_footer_col2_menu_redirect',
				'jot_shop_above_footer_col2_social_media_redirect',
				'jot_shop_above_footer_col3_texthtml',
				'jot_shop_above_footer_col3_widget_redirect',
				'jot_shop_above_footer_col3_menu_redirect',
				'jot_shop_above_footer_col3_social_media_redirect',
				'jot_shop_above_ftr_hgt',
				'jot_shop_abv_ftr_botm_brd',
				'jot_shop_above_frt_brdr_clr',
				],
			...
			},
           {
...

			{
				...
				callback: function(layout){
					var val = api( 'jot_shop_above_footer_col1_set' ).get();
			...
			// col2
			{
				...
				callback: function(layout){
					var val = api( 'jot_shop_above_footer_col2_set' ).get();
			...
			// col3
			{
				...
				callback: function(layout){
					var val = api( 'jot_shop_above_footer_col3_set' ).get();
...
OPNCustomizerToggles ['jot_shop_above_footer_col1_set'] = [
		    {
				controls: [    
				'jot_shop_footer_col1_texthtml',
				'jot_shop_footer_col1_widget_redirect',
				...
				callback: function(layout){
					var val = api( 'jot_shop_above_footer_layout' ).get();
...
OPNCustomizerToggles ['jot_shop_above_footer_col2_set'] = [
		    {
				controls: [    
				'jot_shop_above_footer_col2_texthtml',
				'jot_shop_above_footer_col2_widget_redirect',
...
OPNCustomizerToggles ['jot_shop_above_footer_col3_set'] = [
		    {
				controls: [    
				'jot_shop_above_footer_col3_texthtml',
				'jot_shop_above_footer_col3_widget_redirect',
