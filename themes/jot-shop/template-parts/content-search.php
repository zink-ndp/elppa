					...
					<div class="thunk-posts-description ">
						...
						<div class="thunk-post-comments">
							<div class="thunk-comments-icon">
								<span class="thunk-comments"><a href="<?php comments_link(); ?>" title=""><?php comments_popup_link(esc_html('0','jot-shop'), esc_html('1','jot-shop'), esc_html('%','jot-shop')); ?></a></span>
							</div>
						</div>
					    </div>
						<div class="thunk-post-excerpt">
								<?php jot_shop_the_excerpt();?> 
						</div>
